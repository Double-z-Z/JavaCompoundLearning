...
public class ChatHandler extends SimpleChannelInboundHandler<Message> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Message msg) throws Exception {
        ...
        switch (msg.getType()) {
            ...
            case HISTORY_REQUEST:
                handleHistoryRequest(channel, (HistoryRequestMessage) msg);
                break;
            default:
     ...
     * 处理历史消息请求
     */
    private void handleHistoryRequest(Channel channel, HistoryRequestMessage request) {
        logger.debug("Received history request, count: {}", request.getCount());
        messageService.handleHistoryRequest(channel, request);
    }
